...
CREATE DATABASE IF NOT EXISTS `crimemanagement` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `crimemanagement`;
...
-- Dumping data for table crimemanagement.auth_user: ~0 rows (approximately)
...
-- Dumping data for table crimemanagement.crime_area: ~0 rows (approximately)
...
-- Dumping data for table crimemanagement.crime_complaint_details: ~0 rows (approximately)
...
-- Dumping data for table crimemanagement.crime_fileupload: ~0 rows (approximately)
...
-- Dumping data for table crimemanagement.crime_missing: ~0 rows (approximately)
/*!40000 ALTER TABLE `crime_missing` DISABLE KEYS */;
INSERT INTO `crime_missing` (`id`, `Email`, `firstname`, `lastname`, `perno`, `missedarea`, `my_content`, `image`, `status`) VALUES
	(1, 'prasana@gmail.com', 'Prasana', 'kumar', '09176990190', 'vellore', 'went to katpadi cmc', 'image/download1_uMzoptO.jpg', 'ongoing');
...
-- Dumping data for table crimemanagement.django_session: ~5 rows (approximately)
...
INSERT INTO `django_session` (`session_key`, `session_data`, `expire_date`) VALUES
	...
	('iy3a8g1uyzmougagx73odk4m96a2aup8', 'YTM3MGRiOTVjZjY0NzgxYTg3NzhhN2Y4OGUzMDg4NDFmYTMyNDBiYjp7ImVtYWlsIjoicHJhc2FuYUBnbWFpbC5jb20iLCJibm5hbWUiOiJ2YWRhcGFsYW5pIn0=', '2020-06-20 13:23:16'),
